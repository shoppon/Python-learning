...
class PyFrames(gdb.Command):
    ...
    def invoke(self, args, from_tty):
        address = int(args, 0)
        while address != 0x80 and address != 0x00:
            framePtr = gdb.parse_and_eval("(PyObject*)" + str(address))
            frame = PyFrameObjectPtr.from_pyobject_ptr(framePtr)
